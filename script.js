...
function init() {
  ...
  newTilesElements = document.getElementById('newTiles').getElementsByClassName('tile'); // Array med element för utskrift av nya brickor
  tilesElements = document.getElementById('board').getElementsByClassName('tile'); // Array med element som nya brickor ska dras till
  markElements = document.getElementById('board').getElementsByClassName('mark'); // Array med element för markering av rätt/fel svar
...
function moveTileToBox(e) {
  ...
  if (e.type == 'drop') {
    ...
    if (dropElement.innerHTML == '') {
      ...
      dropElement.classList.remove('empty'); // Ändrar stiler för rutan på tavlan där brickan släpps
      dropElement.classList.add('filled'); // Ändrar stiler för rutan på tavlan där brickan släpps
